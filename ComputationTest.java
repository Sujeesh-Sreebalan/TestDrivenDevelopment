...
class ComputationTest {
	...
	public void calculateLongestMirrorSizeTest() {
		...
		int result = compute.calculateLongestMirrorSize(maxMirror);
	...
	public void calculateLongestMirrorSizeTest3() {
		...
		AssertionError exception = assertThrows(AssertionError.class, () -> compute.calculateLongestMirrorSize(maxMirror));
	...
	public void calculateClumpsTest() {
		...
		int result = compute.calculateClumps(countClumps);
	...
	public void calculateClumpsTest2() {
		...
		AssertionError exception = assertThrows(AssertionError.class, () -> compute.calculateLongestMirrorSize(countClumps));
		assertEquals("Cannot Compute on empty array", exception.getMessage());
	}
	...
	public void fixArrayTest() {
		...
		int fix1[] = {9, 4, 5, 4, 5, 9};
 		int result[] = compute.fixArray(fix, x, y);
	...
	public void fixArrayTest1() {
		...
		int y = 5;
		int fix[] = new int[0];
		AssertionError exception = assertThrows(AssertionError.class, () -> compute.fixArray(fix,x,y));
		assertEquals("Cannot Compute on empty array", exception.getMessage());			
	}
	...
	public void calculateSumTest() {
		...
		int result = compute.calculateSum(splitArray);
		assertEquals(3, result);
	}
	...
	public void calculateSumTest2() {	
		...
		AssertionError exception = assertThrows(AssertionError.class, () -> compute.calculateSum(splitArray));
		assertEquals("Cannot Compute on empty array", exception.getMessage());
